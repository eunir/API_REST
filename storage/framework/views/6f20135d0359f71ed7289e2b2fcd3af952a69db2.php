  ...
  <div class="py-5 text-center text-white" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, .75), rgba(0, 0, 0, .75)), url(https://static.pingendo.com/cover-bubble-dark.svg);  background-position: center center, center center;  background-size: cover, cover;  background-repeat: repeat, repeat;">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-2 p-4" style=""> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="https://static.pingendo.com/img-placeholder-1.svg" alt="Card image cap" width="200">
          <h4> <b>Usuários</b> </h4>
          <p class="mb-0"></p>
        </div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\API_REST\resources\views/Painel.blade.php ENDPATH**/ ?>