    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto text-center col-lg-4">
          <h4 class="mb-3">Tipo: {{ $chamado->tipo_chamado }}</h4>
        </div>
        <div class="mx-auto text-center col-lg-4">
          <h4 class="mb-3">Status: {{ $chamado->status_chamado }}</h4>
        </div>
        <div class="mx-auto text-center col-lg-4">
          <h4 class="mb-3">Responsável: {{ $chamado->responsavel }}</h4>
        </div>
      </div>
      <div class="row">
        <div class="mx-auto text-center col-lg-6">
          <p class="lead mb-4">{{ $chamado->descricao }}</p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="embed-responsive embed-responsive-16by9">
            ...
            <img src="{{'../public/storage/imagens/'.$chamado->imagem_video}}" class="embed-responsive-item"></img>
            @else
            <video src="{{'../public/storage/imagens/'.$chamado->imagem_video}}" class="embed-responsive-item" controls="controls"> Your browser does not support HTML5 video. </video>
            @endif
          </div>
        </div>
